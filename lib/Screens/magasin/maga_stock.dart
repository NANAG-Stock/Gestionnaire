...
class MAgaStock extends StatefulWidget {
  const MAgaStock({Key? key}) : super(key: key);

  @override
  _MAgaStockState createState() => _MAgaStockState();
}

class _MAgaStockState extends State<MAgaStock> {
  ...
  SingleChildScrollView _dataBody(String droit) {
