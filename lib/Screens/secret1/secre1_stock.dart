...
class Secret1Stock extends StatefulWidget {
  const Secret1Stock({Key? key}) : super(key: key);

  @override
  _Secret1StockState createState() => _Secret1StockState();
}

class _Secret1StockState extends State<Secret1Stock> {
