...
class CaisseBonDeSortie extends StatefulWidget {
  const CaisseBonDeSortie({Key? key}) : super(key: key);

  @override
  _CaisseBonDeSortieState createState() => _CaisseBonDeSortieState();
}

class _CaisseBonDeSortieState extends State<CaisseBonDeSortie> {
                                                                  ...
                                                                  if (clienSearch) {
                                                                    ...
                                                                    if (idSearch) {
                                                                      ...
                                                                      if (livraire) {
                                                                        copyListbonSortie = listbonSortie!
                                                                            .where((element) =>
                                                                                (element.livraire_bon.toLowerCase().contains(seach.toLowerCase())))
                                                                            .toList();
                                                                      } else {
                                                                        copyListbonSortie = listbonSortie!
                                                                            .where((element) =>
