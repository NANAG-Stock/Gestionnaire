...
class Secret2Produits extends StatefulWidget {
  const Secret2Produits({Key? key}) : super(key: key);

  @override
  _Secret2ProduitsState createState() => _Secret2ProduitsState();
}

class _Secret2ProduitsState extends State<Secret2Produits> {
  // categorie
