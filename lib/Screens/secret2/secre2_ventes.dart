...
class Secret2Ventes extends StatefulWidget {
  const Secret2Ventes({Key? key}) : super(key: key);

  @override
  _Secret2VentessState createState() => _Secret2VentessState();
}

class _Secret2VentessState extends State<Secret2Ventes> {
                  ...
                  DataCell(
                    Row(
                      ...
                      children: [
                        ...
                        Container(
                          width: 80,
                          child: int.parse(e.is_deliver_com) == 0
                              ? MaterialButton(
                        ...
                        Container(
                          width: 80,
                          child: int.parse(e.is_print_com) == 0
                              ? IconButton(
                                  icon: Icon(
                                    Icons.delete,
                                    color: Colors.red,
                                      ...
                                      if (value == "1") {
                                        setState(() {
                                          ConfirmBox()
                                              ...
                                              .then((value) {
                                            if (!isDeliver) {
                                              getVente('0', seach.text,
                                                  end.text, true, true);
                                            } else {
                                              getVente('1', seach.text,
                                                  end.text, true, true);
                                            }
                                          });
                                        });
